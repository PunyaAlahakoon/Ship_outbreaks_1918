...
prior_params(1)=unifrnd(0.001,5,1,1);
prior_params(11)=unifrnd(0.001,3,1,1);
%bji=repmat(unifrnd(0.001,5),1,2);
prior_params(9)=unifrnd(0.001,6,1,1);
...
%deaths:
prior_params(8)=0; prior_params(10)=0; %no deaths 
