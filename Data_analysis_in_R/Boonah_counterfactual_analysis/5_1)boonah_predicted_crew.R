...
hie_paths=readMat('boonah_predicted_hie_crew.mat')
hie_paths=hie_paths$total.crew.cases
...
sc_paths=readMat('boonah_sc_predicted_paths_c.mat')
sc_paths=sc_paths$sc.paths.c
sc_paths[1:17,]=NA
...
All_pred_crew<-ggarrange(medic_pred_sp,path_diff_plot,path_diff_his,ncol = 3)

All_pred_crew<-annotate_figure(All_pred_crew, top = text_grob("Predicted paths (passengers)", 
