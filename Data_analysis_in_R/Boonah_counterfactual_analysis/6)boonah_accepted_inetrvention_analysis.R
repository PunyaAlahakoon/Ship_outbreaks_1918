...
hie_paths=readMat('INT_paths_T.mat')
...
sc_paths=readMat('NO_paths_T.mat')
...
All_acc<-annotate_figure(All_acc, top = text_grob("Conditional resampled paths (passengers)", 
...
ggsave("boonah_acc_pred.png",last_plot(),height = 10.5,width = 15.5)
