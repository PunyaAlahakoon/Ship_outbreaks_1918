...
sc_paths=readMat('medic_scenario_predicted_paths.mat')
sc_paths=sc_paths$scenario.predicted.paths
sc_paths[1:7,]=NA
...
sc_paths=readMat('medic_scenario_predicted_paths.mat')
sc_paths=sc_paths$scenario.predicted.paths[8:22,]
...
quantile(colSums(sc_paths)-colSums(hie_paths))
...
All_pred<-annotate_figure(All_pred, top = text_grob("Resampled paths", 
