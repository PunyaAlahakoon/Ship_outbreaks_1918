...
hie_paths=readMat('medic_predicted_hie_passengers.mat')
...
sc_paths=readMat('medic_scenario_predicted_passengers.mat')
sc_paths=sc_paths$scenario.predicted.passengers
sc_paths[1:7,]=NA
...
All_pred_pas<-ggarrange(medic_pred_sp,path_diff_plot,path_diff_his,ncol = 3)

All_pred_pas<-annotate_figure(All_pred_pas, top = text_grob("Re-sampled paths", 
