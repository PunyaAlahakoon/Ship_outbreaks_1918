...
while(aa<2)
 ...
 if gen==1 
        ...
        par=[par1(1:6) 0 0 par1(7) 0 par1(8:9)];
             ...
             prod(unifpdf( [par(9) par(12)],0.001,10))*...  %transmission troops
             ...
             prod(lognpdf(symT,2.1,0.7))*... %seriel interval, T
    ...
    if p1>0
               ...
               % t_seq=1:T; stp2=T;
                ...
                %#############################
                %overall infections:
                %inf_g=[14 81];  I don't think this matters because we have
                %a good time series!
