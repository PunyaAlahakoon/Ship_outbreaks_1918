...
%this version also gives the counterfactual paths as well. 


function[prev,daily_c,daily_no_int,prev_N]=Medic_sample_gen_qurantine_countf(groups,params,ini_states,count)
...
props(8,[2:3 5:6])=params(18);
   ...
   %Voyage:          
    ...
    [times1,paths1,counters1]=Gillespe7(ini_states,0,stoi,Ra,stop1,tq+2,1,count);
    e1=paths1{1,1};
    cous=counters1{1,1};
    tt=times1{1,1};
